...
<#
.SYNOPSIS
  Builds a Chrome-Web-Store-compatible ZIP of the BeePlus extension.

.DESCRIPTION
  Packages BeePlus into beeplus-for-beekeeper-v<VERSION>.zip with
  forward-slash paths (Chrome Store requirement).
...
$zipName = "beeplus-for-beekeeper-v$version.zip"
